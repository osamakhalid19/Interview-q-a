  ...
  const reviews = [
    ...
    {
    name: "David Kim",
    designation: "Frontend Engineer, South Korea",
    review:
      "The daily challenges kept me sharp. Within two months, I was ready for interviews and landed a remote position in Seoul.",
  },
  {
    name: "Leila Farouk",
    designation: "DevOps Engineer, Egypt",
    review:
      "I used Code Zode alongside my job. The cloud infrastructure scenarios mirrored real-world problems I faced in interviews.",
  },
  {
    name: "Thomas Müller",
    designation: "Software Developer, Switzerland",
    review:
      "I appreciated the structured learning path and system design content. It made preparing for European tech roles much smoother.",
  },
  {
    name: "Priya Mehta",
    designation: "AI Engineer, India",
    review:
      "I got stuck in tutorial hell before this. Code Zode gave me clarity and confidence to apply for real-world AI roles.",
  },
  {
    name: "Nathan Lee",
    designation: "React Native Developer, Australia",
    review:
      "The mobile-specific interview questions were spot-on. I went in prepared and walked out with an offer the next day.",
  }
  ];
